...
/**
 * Class for displaying the user screen for Other users.
...
public class OtherScreen {
	...
	/**
	 * Other Screen constructor, takes in the given family name and username for the Other user.
	 * 
	 * @param familyName
	 * @param userName
	...
	protected OtherScreen(String familyName, String userName) throws ParseException {
	...
	/**
	 * Creates the main Other user-type UI shell
	 * 
	 * @param display
	 * 
