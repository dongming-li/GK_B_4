 ...
 * 
 * @author Brian
 * The screen to show unavailable times
 */
public class Availability {
	 ...
	 * Sends the time selected by the child into schedule signaling that they are unable to work at specific times
	 */
	protected Availability(String familyName, String childName) throws ParseException {
 ...
 */
	private Shell createShell(Display display) throws ParseException {
		...
		shell.setText("Availabilty");
		shell.setImage(logo);
		
		Label selectTask = new Label(shell, SWT.NONE);
		selectTask.setText("Select hours of unavailability");
		...
		*/
		taskCombo.add("Every week on this day for this time");
		taskCombo.add("Just this specific day's time");
		//taskCombo.add("This day off");
		...
		submitButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
					 ...
					 info.add((String)selectedDate);
					 //ArrayList<Object> times = new ArrayList<Object>();
					 //TODO eventually will let user put in a personalized message merge
					// times.add(selectedTime);
					 //info.add(times);
					// times.add(selectedTime);
					 // info is done in if statement because it works
					 if(selectedTask.equals("Just this specific day's time")){;
						 ArrayList<Object> times = new ArrayList<Object>();
						 times.add(selectedTime);
						 info.add(times);
						 send.add(info);
					 ...
					 else if (selectedTask.equals("Every week on this day for this time")){
	 ...
	 * @param calendar
	 * @throws ParseException
	 * Creates the calendar and select the day as current day
	 */
	 ...
	 * 
	 * @param dailySchedule
	 * Shows the chores for the child on the current day
	 */
	 ...
	 * 
	 * @param data
	 * adds the chores of the child onto the schuldule table
	 */
	...
	/**
	 * creates an empty "time" on the schuldule
	 */
...
/**
 * adds these time to the time selection 
 */
